 ...
 */
import { MDUserAccesss } from './mDUserAccesss';

export interface MDUserPermission { 
    /**
     ...
     */
    mdRole?: MDUserPermission.MdRoleEnum;
    mDUserAccesss?: Array<MDUserAccesss>;
}
export namespace MDUserPermission {
    export type MdRoleEnum = 'cashier' | 'writer' | 'owner' | 'accountant';
    export const MdRoleEnum = {
        Cashier: 'cashier' as MdRoleEnum,
        Writer: 'writer' as MdRoleEnum,
        Owner: 'owner' as MdRoleEnum,
        Accountant: 'accountant' as MdRoleEnum
    };
}