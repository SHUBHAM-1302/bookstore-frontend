...
export interface GroupedBidstatus { 
    /**
     * Different modes of bidding.
     */
    status?: GroupedBidstatus.StatusEnum;
}
export namespace GroupedBidstatus {
    export type StatusEnum = 'NEW' | 'MODIFIED' | 'REMOVED' | 'UNCHANGED';
    export const StatusEnum = {
        NEW: 'NEW' as StatusEnum,
        MODIFIED: 'MODIFIED' as StatusEnum,
        REMOVED: 'REMOVED' as StatusEnum,
        UNCHANGED: 'UNCHANGED' as StatusEnum
    };
}