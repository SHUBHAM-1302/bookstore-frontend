 ...
 */
import { WriterDaySheetItemBidSummary } from './writerDaySheetItemBidSummary';
import { WriterDaySheetItemLotSummary } from './writerDaySheetItemLotSummary';

export interface WriterDaySheetItemSummary { 
    totalSOQuantity?: number;
    soId?: string;
    writerDaySheetItemLotSummary?: WriterDaySheetItemLotSummary;
    writerDaySheetItemBidSummary?: WriterDaySheetItemBidSummary;
}