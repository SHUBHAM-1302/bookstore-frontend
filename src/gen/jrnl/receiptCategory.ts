...
export type ReceiptCategory = 'Advance-Amount' | 'SalesBill' | 'Cash' | 'FromAccount' | 'Others';

export const ReceiptCategory = {
    AdvanceAmount: 'Advance-Amount' as ReceiptCategory,
    SalesBill: 'SalesBill' as ReceiptCategory,
    Cash: 'Cash' as ReceiptCategory,
    FromAccount: 'FromAccount' as ReceiptCategory,
    Others: 'Others' as ReceiptCategory
};