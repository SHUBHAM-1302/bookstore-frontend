...
export type ReceiptStatus = 'RCP_OPEN' | 'RCP_LISTED' | 'RCP_SAVED' | 'RCP_CANCELLED';

export const ReceiptStatus = {
    OPEN: 'RCP_OPEN' as ReceiptStatus,
    LISTED: 'RCP_LISTED' as ReceiptStatus,
    SAVED: 'RCP_SAVED' as ReceiptStatus,
    CANCELLED: 'RCP_CANCELLED' as ReceiptStatus
};