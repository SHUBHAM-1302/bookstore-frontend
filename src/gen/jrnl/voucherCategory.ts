...
export type VoucherCategory = 'Freight-Charges' | 'SalesInvoice' | 'Cash-Payments' | 'Petty-Expenses' | 'Purchases' | 'ToAccount' | 'Others';

export const VoucherCategory = {
    FreightCharges: 'Freight-Charges' as VoucherCategory,
    SalesInvoice: 'SalesInvoice' as VoucherCategory,
    CashPayments: 'Cash-Payments' as VoucherCategory,
    PettyExpenses: 'Petty-Expenses' as VoucherCategory,
    Purchases: 'Purchases' as VoucherCategory,
    ToAccount: 'ToAccount' as VoucherCategory,
    Others: 'Others' as VoucherCategory
};