...
export type VoucherStatus = 'VCH_OPEN' | 'VCH_LISTED' | 'VCH_SAVED' | 'VCH_CANCELLED';

export const VoucherStatus = {
    OPEN: 'VCH_OPEN' as VoucherStatus,
    LISTED: 'VCH_LISTED' as VoucherStatus,
    SAVED: 'VCH_SAVED' as VoucherStatus,
    CANCELLED: 'VCH_CANCELLED' as VoucherStatus
};