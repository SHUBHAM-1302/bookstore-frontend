...
export interface SalePadStatus { 
    /**
     * Different states of Salepad.
     */
    status?: SalePadStatus.StatusEnum;
}
export namespace SalePadStatus {
    export type StatusEnum = 'OPEN' | 'INPROGRESS' | 'COMPLETED';
