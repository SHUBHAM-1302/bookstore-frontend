...
export interface BuyerWeighingInfoOutput {

  /**
   * the mark of the alias
   */
  aliasmark?: string;

  /**
   * the mark of the lotbuyer
   */
  buyermark?: string;
  ...
  /**
   * the mark of the lotbroker
   */
  lotbrokermark?: string;
