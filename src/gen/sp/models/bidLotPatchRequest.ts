 ...
 */
import { ArrayOfUuid } from './arrayOfUuid';
import { SPPatchDocument } from './sPPatchDocument';

/**
 * An object containing list sp id and Patch
 */
export interface BidLotPatchRequest {
    spIds: ArrayOfUuid;
    SPPatchDocument: Array<SPPatchDocument>;
}
