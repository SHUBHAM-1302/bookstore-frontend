...
export interface SalesPadBid {
    /**
     * id created on successful insertion
     */
    readonly salesInvoicebidId?: number;
    /**
     * id for each lot
     */
    lotId?: number;
     ...
     * name for subCmdName
     */
    readonly subCmdName?: string;
    /**
     * id for packageTypeId
     */
    ...
    rate?: number;
    /**
     * goods value of each bid
     */
    siBidGoodsValue?: number;
    /**
     * quantity of each bid
     */
    quantity?: number;
    /**
     * weight of bid
