 ...
 */
import { SalesSummaryPatchDocument } from './salesSummaryPatchDocument';

export interface SalesInvoicesPatch {
    id?: string;
    SalesSummaryPatchRequest?: Array<SalesSummaryPatchDocument>;
}