...
export interface MDReportEquation { 
    /**
     * id of the equation
     */
     ...
     */
    operation?: MDReportEquation.OperationEnum;
    /**
     * operation of the equation
     */
    equationame?: string;
    firstCriteriaItem?: MDReportSearchCriteriaItemTxn;
    secondCriteriaItem?: MDReportSearchCriteriaItemTxn;
    upsertInfo?: UpsertInfo;
}
export namespace MDReportEquation {
    export type OperationEnum = 'ADD' | 'SUB' | 'MUL' | 'REM' | 'DIV';
    export const OperationEnum = {
        ADD: 'ADD' as OperationEnum,
        SUB: 'SUB' as OperationEnum,
        MUL: 'MUL' as OperationEnum,
        REM: 'REM' as OperationEnum,
