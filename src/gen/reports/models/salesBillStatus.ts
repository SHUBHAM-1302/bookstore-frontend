...
export type SalesBillStatus = 'SB_OPEN' | 'SB_PAYMENT_PENDING' | 'SB_CLOSED' | 'SB_PRINTED' | 'SB_CANCELLED';

export const SalesBillStatus = {
    OPEN: 'SB_OPEN' as SalesBillStatus,
    PAYMENTPENDING: 'SB_PAYMENT_PENDING' as SalesBillStatus,
    CLOSED: 'SB_CLOSED' as SalesBillStatus,
    PRINTED: 'SB_PRINTED' as SalesBillStatus,
    CANCELLED: 'SB_CANCELLED' as SalesBillStatus
};