...
export interface ReportSearchRequest { 
     ...
     */
    reportType?: ReportSearchRequest.ReportTypeEnum;
    /**
     * Different types of format
     */
    format?: ReportSearchRequest.FormatEnum;
    upsertInfo?: UpsertInfo;
}
export namespace ReportSearchRequest {
    export type ReportTypeEnum = 'SALESREPORT' | 'USERFEE' | 'COMMISSION';
    export const ReportTypeEnum = {
        SALESREPORT: 'SALESREPORT' as ReportTypeEnum,
        USERFEE: 'USERFEE' as ReportTypeEnum,
        COMMISSION: 'COMMISSION' as ReportTypeEnum
    };
    export type FormatEnum = 'HTML' | 'PDF';
