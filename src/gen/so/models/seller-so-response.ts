...
export interface SellerSOResponse {
  /**
   ...
   */
  readonly status?: SellerSOResponse.StatusEnum;
  /**
...
export namespace SellerSOResponse {
  export type StatusEnum = 'SO_SELLER_CREATED' | 'SO_SELLER_LOT_BID_STARTED' | 'SO_SELLER_SI_READY';
