...
import { SaleOrderPatchDocument } from "./sale-order-patch-document";


export interface SaleOrderMultiplePatch {
    id?: number;
    saleOrderPatchDocument?: Array<SaleOrderPatchDocument>;
}