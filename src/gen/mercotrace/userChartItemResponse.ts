 ...
 */
import { CommodityAddress } from './commodityAddress';
import { CommoditySubType } from './commoditySubType';
import { MarketLocation } from './marketLocation';
import { UpsertInfo } from './upsertInfo';

export interface UserChartItemResponse { 
    /**
     * primary key generated when object is created
     */
    readonly usrChartItemId?: number;
    commodityDistrictNames?: Array<string>;
    commodityStateNames?: Array<string>;
    marketLocation?: Array<MarketLocation>;
    commodityAddress?: Array<CommodityAddress>;
    commoditySubType?: Array<CommoditySubType>;
