...
export interface UpsertInfo { 
    /**
     * user Id who created sales_invoice
     */
    createdBy?: string;
    /**
     * user Id who last modified the sales_invoice
     */
    readonly modifiedBy?: string;
    /**
     * creation date and time of the sales_invoice.
     */
    createdOn?: string;
    /**
     * last modified date and time of the sales_invoice.
     */
