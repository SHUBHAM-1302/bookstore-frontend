...
export interface DatePriceSeriesValues { 
    /**
     * date
     */
    date?: string;
    /**
     * maximum Price of commodity on that date
     */
    maxPrice?: number;
    /**
     * minimum Price of commodity on that date
     */
    minPrice?: number;
    /**
     * totalWeight of commodity on that date
     */
    totalWeight?: number;
    /**
     * avg Price of commodity on that date
     */
    avgPrice?: number;
}