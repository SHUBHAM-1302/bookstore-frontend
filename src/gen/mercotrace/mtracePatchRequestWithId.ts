 ...
 */
import { MtracePatchDocument } from './mtracePatchDocument';

export interface MtracePatchRequestWithId { 
    /**
     * primary key generated when object is created
     */
    cmdOriginPriceSeriesId?: number;
    mtracePatchRequest?: Array<MtracePatchDocument>;
}